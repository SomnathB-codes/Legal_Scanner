"""
database.py — Supabase (Cloud PostgreSQL) helper (fixed)
=========================================================
Handles upsert of court case records including full_text.
...
-- If the table already exists without full_text, run:
